...
export class TrailerComponent implements OnInit {
 ...
 // countryForm: FormGroup;
  ...
  constructor(private fb: FormBuilder, private http: HttpClient, private trailerService: TrailerService ) { }
  ...
  uploadFile(data: FormData): Observable<any> {
    //debugger
    return this.http.post<any>('http://localhost:9999/upload', data);
  }
